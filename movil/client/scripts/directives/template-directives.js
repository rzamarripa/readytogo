...
.directive('myTabs', function() {
	return {
		...
		templateUrl: 'client/templates/common/my-tabs.html'
	};
})
...
.directive('myTab', function() {
	return {
		...
		templateUrl: 'client/templates/common/my-tab.html'
	};
})
...
.directive('showHideContainer', function(){
	return {
		...
		templateUrl: 'client/templates/common/show-hide-password.html',
		restrict: 'A',
		replace: false,
		transclude: true
	};
...
.directive('ionicYoutubeVideo', function($timeout, $ionicPlatform, youtubeEmbedUtils) {
	return {
		...
		templateUrl: 'client/templates/common/ionic-youtube-video.html',
		replace: false
	};
})
...
.directive('multiBg', function(){
	return {
		...
		templateUrl: 'client/templates/common/multi-bg.html',
		restrict: 'A',
		replace: true,
		transclude: true
	};
...
.directive('preImg', function() {
	return {
		...
		templateUrl: 'client/templates/common/pre-img.html'
	};
})
